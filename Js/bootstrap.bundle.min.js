...
/* Permite que el boton con la id cumpla esta funcion y mustra la alerta y redirige*/
Punch.onclick = function(){

  alert('PUNCH');
  document.write('Un Click Poderoso Daño Esta Pagina'+'<br>'+'Recargue o Actualice la pagina');
}
